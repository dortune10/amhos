...
This folder is the source code for a hackathon prototype (Vibe Code Marathon) demonstrating that workflow end-to-end in the browser. See the [repo README](../../README.md) for setup and a full demo walkthrough.
