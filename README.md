...
This is a hackathon prototype (Vibe Code Marathon) demonstrating that workflow end-to-end in the browser. See [app/README.md](app/README.md) for setup and a full demo walkthrough.
